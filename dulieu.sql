...
INSERT INTO `account` (`id`, `username`, `fullname`, `password`, `role`) VALUES
	(1, 'admin', 'nam', '$2y$10$xTLgTVX48OMLEvC/28EYbOMZF9PRZDHghpoHTHPJErFc8Z/PLbpFu', 'admin'),
	(2, 'admin1', 'nu', '$2y$10$DNG7XrDoCVVzZHT09UxrMumHnxIBIqUqj75.0fWNhEmrC8v3nLoI.', 'user');
...
INSERT INTO `product` (`id`, `name`, `description`, `price`, `image`, `category_id`) VALUES
	(1, 'Asus Rog', 'Gaming', 25.00, 'uploads/images.jpg', 2),
	(2, 'Macbook', 'Van phong', 20.00, 'uploads/macbook_pro_13_inch_intel_m1.jpg', 2),
	(3, 'Samsung Galaxy', 'lien lac', 15.00, 'uploads/tải xuống.jpg', 1),
	(4, 'Airpods', 'nghe', 10.00, 'uploads/tải xuống (1).jpg', 5);
